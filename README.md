...
[![Build Status](https://ci-builds.apache.org/buildStatus/icon?job=Doris%2Fdoris_daily_enable_vectorized&build=0)](https://ci-builds.apache.org/job/Doris/job/doris_daily_enable_vectorized/)
