...
private:
    ...
    std::atomic<int> _num_unstarted_scan_ranges;
    ...
    // to be queued).
    std::atomic<int> _num_used_buffers;
    ...
    std::atomic<int> _num_ready_buffers;
    ...
    std::atomic<int> _total_range_queue_capacity;
    ...
    private:
        ...
        std::atomic<int> _num_threads_in_op;
